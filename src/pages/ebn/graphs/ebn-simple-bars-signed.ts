...
export  class EbnSimpleBarsSignedV1 extends GraphControllerV3  {
    ...
    async init() {
        ...
        this.chartBar = new elements.ChartBarsHorizontalSigned(this);
    ...
    async redraw(data: any, range: number[]) {
        ...
        this.scales.y.set(data.slice.map ( d => d.value).concat([-7000 * 1000 * 1000 ,10000 * 1000 * 1000]));
