...
import { AxisArrow, ChartBarReconciliation, ChartBarReconciliationV2, ChartBarReconciliationV3, ChartBarReconciliationV4, ChartGrid, HTMLTable, HtmlFunctionality, HtmlHeader, HtmlLegend, HtmlLegendColumn, ZeroLine } from '@local/elements';
...
export class ReconciliationCompanyV3 extends GraphControllerV2 {
    ...
    pre() {
        ...
        this._addAxis('x','x','bottom','currency');
    ...
    init() {
        ...
        this.chartBar = new ChartBarReconciliationV4(this);
    ...
    prepareData(data: EitiReport[]) : any {
        ...
        const p1 = "discrepancy_company_absolute";
        const p2 = "discrepancy_government_absolute";
        const p3 = "payments_companies"
        const p4 = "payments_government"
