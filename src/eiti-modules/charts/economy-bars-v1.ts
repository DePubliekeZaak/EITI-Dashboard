...
import { ChartBarVertical, ChartBarVerticalDoublesV1, HtmlFunctionality, HtmlHeader, HtmlLegend, HTMLTable } from '@local/elements';
...
export class EconomyBarsV1 extends GraphControllerV2  {
